                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="p-4 md:p-5 text-center">
                        ...
                        <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400"
                            style="color: #FF7F50; text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.5);">¿A DONDE TE QUIERES
                            DIRIGIR?</h3>
                        <a href="{{route('sve.index')}}" data-modal-hide="popup-modal" type="button"
                            class="text-gray-500 bg-white hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-200 rounded-lg border border-gray-200 text-sm font-medium px-5 py-2.5 hover:text-gray-900 focus:z-10 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-500 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-600 mb-2"
                            style="color: #FF0000; text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.5);">
                            SISTEMA DE VOTACION ESTUDIANTIL
                        </a>
                        <a href="{{ route('login') }}" data-modal-hide="popup-modal" type="button"
